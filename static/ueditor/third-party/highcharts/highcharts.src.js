...
var UNDEFINED,
	...
	isTouchshop = /(Mobile|Android|Windows Phone)/.test(userAgent),
...
Pointer.prototype = {
	...
	init: function (chart, options) {
		...
		// Do we need to handle click on a touch shop?
	...
	pinch: function (e) {
		...
		// On touch shops, only proceed to trigger click if a handler is defined
